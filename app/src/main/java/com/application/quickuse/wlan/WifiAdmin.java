...
public class WifiAdmin {
    ...
    */
        ...
        for (int i = 0; i < wifiConfigList.size(); i++) {
            ...
            if (wifi.networkId == wifiId) {
                while (!(mWifiManager.enableNetwork(wifiId, true))) {// 激活该Id，建立连接
                    ...
                    Log.i(TAG, "ConnectWifi " + String.valueOf(wifiConfigList.get(wifiId).status));
                }
                return true;
            }
        }
    ...
    public int IsConfiguration(String SSID) {
        ...
        Log.i(TAG, "IsConfiguration wifiConfigList size : " + String.valueOf(wifiConfigList.size()) + ",  SSID is " + SSID);
    ...
    public int GetWifiConfig(String SSID, WifiConfiguration WifiConfiguration) {
    ...
    public int AddWifiConfig(List<ScanResult> wifiList, String ssid, String pwd) {
        ...
        for (int i = 0; i < wifiList.size(); i++) {
            ...
            Log.i(TAG, "AddWifiConfig wifi.SSID : " + wifi.SSID + " , ssid : " + ssid);
            if (wifi.SSID.equals(ssid)) {
                Log.i(TAG, "AddWifiConfig  SSID equals");
        ...
        Log.i(TAG, "AddWifiConfig wifiId is -1");
        return wifiId;
    }
